...
const CoordinatorRequestPanel = () => {
    ...
    const fetchData = async () => {
        ...
        const requestsPromise = axios.get('https://kitchen-turn-project-4.onrender.com/skip-requests/');
        const statsPromise = axios.get('https://kitchen-turn-project-4.onrender.com/skip-requests/stats');
    ...
    useEffect(() => {
     ...
     const handleApprove = async (id, studentName) => {
        ...
        try {
            await axios.patch(
                `https://kitchen-turn-project-4.onrender.com/skip-requests/approve/${id}`,
                { studentName },
     ...
     const handleReject = async (id) => {
        ...
        try {
            await axios.patch(
                `https://kitchen-turn-project-4.onrender.com/skip-requests/reject/${id}`,
                {},
                { headers: { userrole: userRole } }
            );
