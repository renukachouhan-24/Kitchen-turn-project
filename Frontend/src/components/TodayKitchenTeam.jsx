...
const TodayKitchenTeam = () => {
     ...
     const fetchData = async () => {
        try {
            const [menuRes, studentsRes, feedbackRes, topTeamsRes, photosRes] = await axios.all([
                ...
                axios.get('https://kitchen-turn-project-2-6t8e.onrender.com/menu/today'),
                axios.get('https://kitchen-turn-project-2-6t8e.onrender.com/students/active'),
                axios.get('https://kitchen-turn-project-2-6t8e.onrender.com/api/feedback'),
                axios.get('https://kitchen-turn-project-2-6t8e.onrender.com/api/ratings/top-teams'),
                axios.get('https://kitchen-turn-project-2-6t8e.onrender.com/api/photos')
    ...
    useEffect(() => {
     ...
     const handleAddMealItem = (e) => {
        ...
        axios.patch(`https://kitchen-turn-project-2-6t8e.onrender.com/menu/update-meal/${mealType}`, { foodName, nutrients })
    ...
    const handleRemoveMealItem = (mealType, itemId) => {
        ...
        axios.patch(`https://kitchen-turn-project-2-6t8e.onrender.com/menu/remove-meal/${mealType}/${itemId}`)
    ...
    const handleFeedbackSubmit = (e) => {
        ...
        axios.post('https://kitchen-turn-project-2-6t8e.onrender.com/api/feedback/add', newFeedback)
    ...
    const handleRateFood = (starValue) => {
        ...
        axios.post('https://kitchen-turn-project-2-6t8e.onrender.com/api/ratings/add', { teamMembers, starValue })
    ...
    const handleResetStars = () => {
        if (window.confirm("Are you sure you want to reset all team ratings to zero? This action cannot be undone.")) {
            ...
            axios.post('https://kitchen-turn-project-2-6t8e.onrender.com/api/ratings/reset')
    ...
    const handleRemovePhoto = async (photoId) => {
        try {
            ...
            await axios.delete(`https://kitchen-turn-project-2-6t8e.onrender.com/api/photos/${photoId}`);
